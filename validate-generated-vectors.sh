...
ffmpeg -y -v error -f lavfi -i testsrc2=duration=0.2:size=854x480:rate=30 -vf $bt709 -color_primaries bt709 -color_trc bt709 -colorspace bt709 -pix_fmt yuv440p -c:v libvpx-vp9 -profile:v 1 -deadline good -cpu-used 4 -crf 24 -b:v 0 -threads 2 "$tmpdir/sdr-testsrc2-vp9-profile1-yuv440p.webm"
...
ffmpeg -y -v error -f lavfi -i testsrc2=duration=0.2:size=854x480:rate=30 -vf $bt709 -color_primaries bt709 -color_trc bt709 -colorspace bt709 -pix_fmt gbrp12le -c:v libvpx-vp9 -profile:v 3 -deadline good -cpu-used 4 -crf 24 -b:v 0 -threads 2 "$tmpdir/sdr-testsrc2-vp9-profile3-gbrp12le.webm"
