...
ffmpeg -y -v error -f lavfi -i yuvtestsrc=duration=0.2:size=1920x1080:rate=30 -color_primaries bt709 -color_trc bt709 -colorspace bt709 -pix_fmt yuv420p10 -c:v libsvtav1 -preset 11 -crf 35 -svtav1-params lp=2 "$tmpdir/sdr-yuvtestsrc-av1-yuv420p10.webm"
